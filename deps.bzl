...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:8foAy0aoO5GkqCvAEJ4VC4P3zksTg4X4aJCDpZzmgQI=",
        version = "v0.0.0-20210503195802-e9a32991a82e",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:nTDGCTeAu2LhcsHTRzjyIUbZHCJ4QePArsm27Hka0UM=",
        version = "v0.0.0-20210504132125-bbd867fde50d",
    )
    go_repository(
